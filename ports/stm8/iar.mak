...
#   set PATH=%PATH%;C:\Program Files (x86)\GnuWin32\bin;C:\Program Files (x86)\IAR Systems\Embedded Workbench 8.0\stm8\bin
#   set MAKE_MODE=DOS
...
EWSTM8_DIR=C:\Program Files (x86)\IAR Systems\Embedded Workbench 8.0\stm8
KERNEL_DIR=../../kernel
TESTS_DIR=../../tests
