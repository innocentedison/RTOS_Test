...
/** @defgroup I2C_Private_Defines
  ...
  */
/* I2C register mask */
#define REGISTER_Mask               ((u16)0x3000)
#define REGISTER_SR1_Index          ((u16)0x0100)
#define REGISTER_SR2_Index          ((u16)0x0200)
/* I2C Interrupt Enable mask */
#define ITEN_Mask                   ((u16)0x0700)
/* I2C FLAG mask */
#define FLAG_Mask                   ((u16)0x00FF)
/**
  * @}
  */
...
I2C_Event_TypeDef I2C_GetLastEvent(void)
{
  ...
  else
  {
    ...
    lastevent = ((u16)((u16)flag2 << 8) | (u16)flag1);
  }
  /* Return status */
...
void I2C_ClearFlag(I2C_Flag_TypeDef I2C_FLAG)
{
  ...
  flagpos = (u16)I2C_FLAG & FLAG_Mask;
  /* Clear the selected I2C flag */
  I2C->SR2 = (u8)((u16)(~flagpos));
}
...
ITStatus I2C_GetITStatus(I2C_ITPendingBit_TypeDef I2C_ITPendingBit)
{
  ...
  __IO u8 enablestatus = 0;
  u16 tempregister = 0;

    /* Check the parameters */
    assert_param(IS_I2C_ITPENDINGBIT_OK(I2C_ITPendingBit));

  tempregister = (u8)( ((u16)((u16)I2C_ITPendingBit & ITEN_Mask)) >> 8);

  /* Check if the interrupt source is enabled or not */
  enablestatus = (u8)(I2C->ITR & ( u8)tempregister);

  if ((u16)((u16)I2C_ITPendingBit & REGISTER_Mask) == REGISTER_SR1_Index)
  {
    /* Check the status of the specified I2C flag */
    if (((I2C->SR1 & (u8)I2C_ITPendingBit) != RESET) && enablestatus)
    {
      /* I2C_IT is set */
      bitstatus = SET;
    }
  ...
  {
    /* Check the status of the specified I2C flag */
    if (((I2C->SR2 & (u8)I2C_ITPendingBit) != RESET) && enablestatus)
    {
      /* I2C_IT is set */
      bitstatus = SET;
    }
...
void I2C_ClearITPendingBit(I2C_ITPendingBit_TypeDef I2C_ITPendingBit)
{
  ...
  /* Get the I2C flag position */
  flagpos = (u16)I2C_ITPendingBit & FLAG_Mask;
