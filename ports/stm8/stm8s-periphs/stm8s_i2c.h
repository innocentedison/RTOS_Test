...
{
    /* SR1 register flags */
    I2C_ITPENDINGBIT_TXEMPTY             = (u16)0x1680, 	/*!< Transmit Data Register Empty  */
    I2C_ITPENDINGBIT_RXNOTEMPTY          = (u16)0x1640, 	/*!< Read Data Register Not Empty  */
    I2C_ITPENDINGBIT_STOPDETECTION       = (u16)0x1210, 	/*!< Stop detected  */
    I2C_ITPENDINGBIT_HEADERSENT          = (u16)0x1208, 	/*!< 10-bit Header sent */
    I2C_ITPENDINGBIT_TRANSFERFINISHED    = (u16)0x1204, 	/*!< Data Byte Transfer Finished  */
    I2C_ITPENDINGBIT_ADDRESSSENTMATCHED  = (u16)0x1202, 	/*!< Address Sent/Matched (master/slave)  */
    I2C_ITPENDINGBIT_STARTDETECTION      = (u16)0x1201, 	/*!< Start bit sent  */

    /* SR2 register flags */
    I2C_ITPENDINGBIT_WAKEUPFROMHALT      = (u16)0x2220, 	/*!< Wake Up From Halt  */
...
#define IS_I2C_CLEAR_FLAG_OK(FLAG) ((((u16)(FLAG) & (u16)0xFD00) == 0x00) \
                                     && ((u16)(FLAG) != 0x00))
...
#define IS_I2C_EVENT_OK(EVENT) (((EVENT) == I2C_EVENT_SLAVE_TRANSMITTER_ADDRESS_MATCHED) || \
                             ...
                             ((EVENT) == (I2C_EVENT_SLAVE_BYTE_RECEIVED | (u16)I2C_FLAG_GENERALCALL)) || \
                             ((EVENT) == I2C_EVENT_SLAVE_BYTE_TRANSMITTED) || \
                             ((EVENT) == (I2C_EVENT_SLAVE_BYTE_TRANSMITTED | (u16)I2C_FLAG_GENERALCALL)) || \
 ...
 *     & SR3 status registers in a single word (u16) (Status Register 3 value
